...
const PrintPayslip = ({ payroll, onClose }: PrintPayslipProps) => {
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr style="font-weight: bold;">
                    ...
                    <td class="text-right">${formatCurrency(payroll.total_deductions || "0.00")}</td>
                  </tr>
                </tbody>
              </table>
  ...
  <tbody>
    ...
    <tr>
      <td className="font-bold border border-black p-1">Cut-off Period</td>
      <td className="border border-black p-1">
        {payroll.period_start && payroll.period_end
          ? `${formatDate(payroll.period_start)} to ${formatDate(payroll.period_end)}`
          : "March 10 to 16, 2025"}
              ...
              {payroll.daily_rates
                ...
                : Array.from({ length: 7 }, (_, i) => (
                    <tr key={i}>
                      ...
                      <td className="border border-black p-1 text-right">545.15</td>
